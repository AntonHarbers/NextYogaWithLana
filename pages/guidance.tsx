...
export default function Coaching({ guidancePosts ,posts, testimonailPosts, meditationPosts, leelaPosts, leelaTestimonialsPosts }: Props) {
  ...
  return (
    <motion.div className="flex flex-col m-auto w-full py-2 justify-center"
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
...
<div id="guidance section" className=" h-auto bg-secondary flex flex-col">
      ...
      <div id="coaching section" className=" h-auto flex flex-col">
        ...
        <motion.div
          ...
          <PortableText
            ...
            serializers={{
              ...
              normal: (props: any) => (
                <h1 className="font-semibold my-2 drop-shadow-[5px_5px_5px_rgba(0,0,0,.5)]" {...props} />
              ),
              h2: (props: any) => (
        ...
        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 1, duration: 2, ease: "easeInOut" }} id="bodyContent" className="flex flex-col-reverse xl:flex-row w-5/6 justify-between mx-auto my-10">
          <PortableText
          ...
          <motion.img
            ...
            animate={{ opacity: 1, x: 0 }}
            transition={{ ease: "easeInOut", duration: 2 }}
            className=" mb-10 xl:mb-0 mx-auto xl:mx-0 h-[20rem] xl:h-[27rem] w-auto border-r-4 border-t-4 border-greens border-opacity-50 rounded-sm" src={
        ...
        <button
          ...
          Sign up here</button>
        <div id="bottomContenct" className="flex flex-col-reverse xl:flex-row w-5/6 mx-auto justify-between my-20">
          <PortableText
            ...
            serializers={{
              ...
              normal: (props: any) => (
                <h1 className="font-semibold text-2xl my-2 px-5 py-2" {...props} />
              ),
              h2: (props: any) => (
                <h1 className='text-4xl text-center font-bold py-5' {...props} />
              ),
            }
            } />
          <PortableText
            ...
            serializers={{
              ...
              normal: (props: any) => (
                <h1 className="font-semibold text-center xl:text-end text-2xl my-2 py-2 " {...props} />
              ),
              h2: (props: any) => (
                <h1 className='text-4xl text-center xl:text-end font-bold py-5 ' {...props} />
              ),
            }
            } />
        </div>
      ...
      <div id="meditation section" className=" h-auto bg-secondary flex flex-col">
        <div id="headerText" className="mx-auto my-20 text-6xl text-center font-Julius">
          {meditationPosts[0].header}
        </div>
        <div id="content" className="flex flex-col-reverse xl:flex-row w-5/6 mx-auto">
          <div id="leftSide" className=" w-full xl:w-1/2 flex flex-col justify-center mb-10 xl:mb-0">
            <PortableText
          ...
          <motion.div
            ...
            <AnimatePresence>
              <motion.img animate={{ top: [-10, 10, -10] }} transition={{ repeat: Infinity, duration: 3 }} className=" relative w-auto h-5/6" src={urlFor(meditationPosts[0].mainImage).url()!} alt="" />
            </AnimatePresence>
          </motion.div>
      ...
      <div id="leela section" className=" h-auto bg-greensLite flex flex-col ">
        <h1 className="text-center my-20 mx-10 xl:m-20 text-6xl font-Julius">LEELA - THE GAME OF SELF-KNOWLEDGE</h1>
        <div id="leelaGameContent" className="flex flex-col xl:flex-row w-5/6 items-center justify-between mx-auto">
          <div className="w-full xl:w-3/4 flex items-center justify-between">
            <img className="w-full h-auto border-r-4 border-t-4 border-greens border-opacity-50 rounded-sm" src={urlFor(leelaPosts[0].backgroundImage).url()!} alt="" />
          </div>
        ...
        <div id="testimonialsAndCertificate" className=" w-5/6 flex flex-col justify-between mx-auto">
          <div id="top" className="flex flex-col-reverse xl:flex-row justify-center mt-20 mb-10 xl:my-32">
            <div id="left" className="w-full xl:w-1/3 h-auto flex flex-col justify-center bg-greens bg-opacity-10 hover:bg-opacity-20 transition duration-300 ease-in-out rounded-lg">
              <motion.h1 animate={{ y: [0, 10, 0] }} transition={{ repeat: Infinity, duration: 2 }} className="text-6xl font-serif w-2/3 mx-auto">"</motion.h1>
              <PortableText
                ...
                serializers={{
                  ...
                  normal: (props: any) => (
                    <h1 className="font-semibold text-xl my-2 py-1" {...props} />
                  ),
                  h2: (props: any) => (
                    <h1 className='text-4xl text-center font-bold py-2' {...props} />
                  ),
              ...
              <motion.h1 animate={{ y: [0, -10, 0] }} transition={{ repeat: Infinity, duration: 2 }} className=" text-6xl font-serif w-2/3 mx-auto text-right">"</motion.h1>
            </div>
            <div id="right" className="w-full xl:w-2/3 flex flex-col">
              <div className="my-10 xl:my-0">
                <img className="w-full h-auto mx-0 xl:mx-10 border-b-4 border-l-4 border-greens border-opacity-50" src={urlFor(leelaPosts[0].certImage).url()!} alt="" />
              </div>
            </div>
          </div>
          <div id="bot">
            ...
            {submitted ? (
              ...
              <form onSubmit={handleSubmit(onSubmit)}>
                <div className="flex flex-col justify-center items-center">
                  <div className="flex flex-col justify-center items-center">
                    <h1 className="text-2xl md:text-4xl font-bold text-white">Sign up form</h1>
                    <h1 className="text-xl md:text-2xl font-bold text-white my-10">Fill out the form below to get started</h1>
                  </div>
                  <div className="flex flex-col justify-center items-center">
                    <input
                      {...register("type")}
                    ...
                    <label htmlFor="name" className="mb-5 block">
                      ...
                      <input {...register("name", { required: true })} className=' text-center shadow border rounded py-2 px-3 form-input mt-1 block w-[70vw] md:w-[25vw] ring-green-500 outline-none focus:ring md:min-w-[25rem]' placeholder='Name' type="text" />
                    </label>
                    <label className='block mb-5'>
                      <span className='text-greensLite'>Email</span>
                      <input  {...register("email", { required: true, pattern: /^[^\s@]+@[^\s@]+\.[^\s@]+$/ })} placeholder='first.last@email.com' type="text" className='text-center shadow border rounded py-2 px-3 form-input mt-1 block w-[70vw] md:w-[25vw] md:min-w-[25rem] ring-green-500 outline-none focus:ring' />
                    </label>
                    <label className='block mb-5'>
                      <span className='text-greensLite'>Request</span>
                      <textarea  {...register("request", { required: true })} className='shadow border rounded py-2 px-3 outline-none focus:ring form-textarea mt-1 block w-[70vw] md:w-[25vw] ring-green-500 md:min-w-[25rem]' placeholder='Your request...' rows={8} />
                    </label>
                    <label className='block mb-5'>
                      <span className='text-greensLite'>Preferred Date</span>
                      <input type="date"  {...register("date", { required: true })} className=' text-center shadow border rounded py-2 px-3 outline-none focus:ring form-textarea mt-1 block w-[70vw] md:w-[25vw] md:min-w-[25rem] ring-green-500' />
                    </label>
                    <label className='block mb-5'>
                      <span className='text-greensLite'>Preferred Time</span>
                      <input type="time"  {...register("time", { required: true })} className=' text-center shadow border rounded py-2 px-3 outline-none focus:ring form-textarea mt-1 block w-[70vw] md:w-[25vw] md:min-w-[25rem] ring-green-500' />
                    </label>
                  </div>
                  <div className='flex flex-col p-5'>
                    ...
                    {errors.email && (
                      <span className='text-red-500 text-sm'>- Emal is required</span>
                    )}
                    {errors.date && (
                  ...
                  <div className="mx-auto w-full text-center mb-32 lg:mb-0">
                    <button className="text-white bg-red-600 hover:bg-opacity-70 py-2 px-4 cursor-pointer rounded focus:outline-none mx-10 " onClick={() => {
                      setActive(false)
                      setRequestType("")
                    }}>Back</button>
                    <input type='submit' className='shadow bg-greens hover:bg-opacity-70 focus:outline-none text-white mx-10 font-bold py-2 px-4 cursor-pointer rounded' />
                  </div>
                </div>
              </form>
            )}
